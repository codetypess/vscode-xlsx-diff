...
export const RUNTIME_MESSAGES = {
    en: {
        ...
        editorPanel: {
            ...
            searchScopeWholeSheet: "Whole sheet",
            searchClose: "Close",
            ...
            setRowHeightPrompt:
                "Enter a row height. Leave the value empty to reset the row to its default height.",
            setRowHeightTitle: "Set Row Height",
            invalidRowHeight: "Enter a positive number, or leave the value empty to reset it.",
            insertColumnLeft: "Insert Column Left",
            insertColumnRight: "Insert Column Right",
            deleteColumn: "Delete Column",
            setColumnWidth: "Set Column Width",
            setColumnWidthPrompt:
                "Enter a column width. Leave the value empty to reset the column to its default width.",
            setColumnWidthTitle: "Set Column Width",
            invalidColumnWidth: "Enter a positive number, or leave the value empty to reset it.",
            ...
            replaceCount: "Replaced {count} matching cells.",
            replaceNoEditableMatches: "No editable matching cells were found.",
            replaceNoChanges: "No values changed.",
            debugRenderSummary: "{rowCount} rows {columnCount} cols",
            debugRenderTooltip: "Rendered {rowCount} rows and {columnCount} columns.",
    ...
    "zh-CN": {
        ...
        editorPanel: {
            ...
            replacePlaceholder: "替换匹配单元格中的内容",
            findPrev: "上一个",
            findNext: "下一个",
            replaceAll: "全部替换",
            filterSelection: "筛选选区",
            clearFilterRange: "清除筛选",
            sortAscending: "升序",
            sortDescending: "降序",
            filterSearchPlaceholder: "搜索值",
            filterSelectAll: "全选",
            filterClearColumn: "清除此列筛选",
            filterBlankValue: "（空白）",
            filterNoValues: "没有可用值",
            ...
            deleteRow: "删除行",
            setRowHeight: "设置行高",
            setRowHeightPrompt: "输入行高；留空则恢复为默认行高。",
            setRowHeightTitle: "设置行高",
            invalidRowHeight: "请输入大于 0 的数值，或留空以恢复默认行高。",
            insertColumnLeft: "在左侧插入列",
            insertColumnRight: "在右侧插入列",
            deleteColumn: "删除列",
            setColumnWidth: "设置列宽",
            setColumnWidthPrompt: "输入列宽；留空则恢复为默认列宽。",
            setColumnWidthTitle: "设置列宽",
            invalidColumnWidth: "请输入大于 0 的数字，或留空以恢复默认列宽。",
            ...
            replaceCount: "已替换 {count} 个匹配单元格。",
            replaceNoEditableMatches: "没有找到可编辑的匹配单元格。",
            replaceNoChanges: "没有单元格值发生变化。",
            debugRenderSummary: "{rowCount}行 {columnCount}列",
            debugRenderTooltip: "当前渲染 {rowCount} 行，{columnCount} 列。",
            searchRegex: "使用正则表达式",
