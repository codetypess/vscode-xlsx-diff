...
function applyPendingEditStyles(): void {
	...
	for (const rowHeader of document.querySelectorAll<HTMLElement>('th[data-role="grid-row-header"]')) {
	...
	for (const colHeader of document.querySelectorAll<HTMLElement>('thead th[data-column-number]')) {
