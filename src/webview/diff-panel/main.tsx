...
const vscode = getVsCodeApi<DiffWebviewOutgoingMessage>();
...
function DiffBootstrapApp() {
    ...
    const measureSheetTabWidths = () => {
        setMeasuredSheetTabWidths(
            readSheetTabWidths(sheetTabsMeasureElement, {
                itemSelector: '[data-role="diff-sheet-tab-measure"]',
                maxWidth: DIFF_SHEET_TAB_VISIBLE_MAX_WIDTH,
            })
        );
    };
